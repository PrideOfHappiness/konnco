            ...
            <section class="content"> 
                ...
                <form action="{{route('product.update', $data->id) }}" method="post" enctype="multipart/form-data"> 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="stok" id="stok" class="form-control" value="{{$data->stokProduk}}" readonly>
                    </div>
                    <div class="input-group mb-3">
                        <label class="form-control">Status Produk</label>
                        <input type="number" name="stok" id="stok" class="form-control" value="{{$data->statusProduk}}" readonly>
                    </div>
                    <div class="mb-3">
